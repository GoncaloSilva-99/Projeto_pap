...
class ClubSportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create club_sport" do
    assert_difference("ClubSport.count") do
      post club_sports_url, params: { club_sport: { club_profiles_id: @club_sport.club_profiles_id, sports_id: @club_sport.sports_id } }
    end
  ...
  test "should update club_sport" do
    patch club_sport_url(@club_sport), params: { club_sport: { club_profiles_id: @club_sport.club_profiles_id, sports_id: @club_sport.sports_id } }
