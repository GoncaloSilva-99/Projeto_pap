class Post < ApplicationRecord
  ...
  validates :content, presence: { message: "não pode ficar em branco" }, length: { minimum: 1, maximum: 500, too_short: "é demasiado curto (mínimo de 1 caractere)", too_long: "é demasiado grande (máximo 500 caracteres)" }
