class PlayerProfilesController < ApplicationController
  ...
  private
    ...
    def player_profile_params
      params.expect(player_profile: [ :user_id, :name, :status, :approved_by, :bio, :banner_picture, :profile_picture, :birth_date, :sport, :position, :secondary_position, :club_profile_id ])
    end
end
