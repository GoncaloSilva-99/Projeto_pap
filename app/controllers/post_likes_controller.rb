class PostLikesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @post_like.update(post_like_params)
        format.html { redirect_to @post_like, notice: "Post like was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to post_likes_path, notice: "Post like was successfully destroyed.", status: :see_other }
